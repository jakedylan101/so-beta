            ...
            <div ref={dropdownRef} className="mt-2 border border-zinc-700 rounded-lg bg-zinc-800 max-h-48 overflow-auto z-50">
              ...
              {venueOptions.map((option, index) => (
                <button
                  ...
                  type="button"
                  onMouseDown={(e) => {
                    // CRITICAL: Prevent input blur by stopping ALL events
                    e.preventDefault();
                    e.stopPropagation();
                  ...
                  className="w-full text-left px-3 py-2 hover:bg-zinc-700 border-b border-zinc-700 last:border-b-0 transition-colors cursor-pointer focus:outline-none"
