...
export async function PUT(
  ...
  console.log(`[Friends] Accepting friend request from user: ${friendId} for user: ${userId}`);
  ...
  // Call the RPC function to accept friend request
  ...
  console.log(`[Friends] Successfully accepted friend request from user: ${friendId} for user: ${userId}`);
